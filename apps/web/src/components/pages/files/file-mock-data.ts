/**
 * 文件模块 Mock 数据（Phase 2 追踪链路升级版）
 * —— 12 条文件记录，覆盖所有分类，新增 sourceType / taskId / workflowRunId / receiptHash / connectorId
 */
...
export const mockFiles: FileItem[] = [
  {
    ...
    size: 3.2 * 1024 * 1024,
    sourceType: "artifact",
    taskId: "task-customer-profiling-042",
    workflowRunId: "wfr-20260605-001",
    receiptHash: "a3f8b2c1",
    connectorId: "conn-customer-analytics",
  ...
  },
  {
    ...
    size: 1.5 * 1024 * 1024,
    sourceType: "artifact",
    taskId: "task-contact-summary-018",
    workflowRunId: "wfr-20260604-002",
    receiptHash: "b7e1d9f4",
    connectorId: "conn-crm-sync",
  ...
  },
  {
    ...
    size: 1.8 * 1024 * 1024,
    sourceType: "artifact",
    taskId: "task-quotation-gen-029",
    workflowRunId: "wfr-20260605-003",
    receiptHash: "d2c4e8a6",
    connectorId: "conn-quote-generator",
    relatedProjectId: "proj-001",
    relatedProjectName: "美国 BrightPath 户外灯具订单",
  ...
  },
  {
    ...
    size: 956 * 1024,
    sourceType: "artifact",
    taskId: "task-quotation-gen-031",
    workflowRunId: "wfr-20260603-004",
    receiptHash: "e5f7b3d1",
    connectorId: "conn-quote-generator",
  ...
  },
  {
    ...
    size: 4.1 * 1024 * 1024,
    sourceType: "artifact",
    taskId: "task-contract-review-055",
    workflowRunId: "wfr-20260606-005",
    receiptHash: "f1a9c7d3",
    connectorId: "conn-legal-reviewer",
  ...
  },
  {
    ...
    size: 48.5 * 1024 * 1024,
    sourceType: "artifact",
    taskId: "task-video-gen-007",
    workflowRunId: "wfr-20260528-006",
    receiptHash: "c8b4a2e0",
    connectorId: "conn-video-processor",
    relatedProjectId: "proj-005",
    relatedProjectName: "智能家居产品线 2026 出海计划",
    relatedAgentIds: ["agent-005"],
  ...
  },
  {
    ...
    size: 22.1 * 1024 * 1024,
    sourceType: "artifact",
    taskId: "task-meeting-transcribe-012",
    workflowRunId: "wfr-20260603-007",
    receiptHash: "9f6d3a1b",
    connectorId: "conn-audio-transcriber",
    relatedProjectId: "proj-003",
    relatedProjectName: "日本 Sakura 家居收纳新品开发",
