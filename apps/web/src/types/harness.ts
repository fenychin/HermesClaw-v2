 ...
 */
export type { HarnessProposal as ContractHarnessProposal } from "@hermesclaw/event-contracts"
...
export interface HarnessEvaluateResult {
  ...
  evaluationReport?: import('@hermesclaw/event-contracts').EvaluationReport
