...
function ConnectorDrawer({
  ...
  return (
    <>
      ...
      {/* 滑出面板 */}
      <div className="bg-sidebar border-border fixed right-0 top-0 z-50 flex h-full w-[420px] flex-col border-l shadow-2xl">
        {/* 顶部 */}
        ...
        <div className="flex-1 space-y-5 overflow-y-auto p-5">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              {connector.permissions.includes("read") &&
              connector.permissions.some((p) =>
                ["send", "write", "create"].includes(p)
              )
                ? "双向读写"
                : connector.permissions.includes("read")
                  ? "仅读取"
