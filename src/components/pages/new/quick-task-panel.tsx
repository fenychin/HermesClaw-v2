    ...
    <div className="bg-card border-border space-y-3 rounded-xl border p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="bg-brand hover:bg-brand/90 inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-primary-foreground transition-colors disabled:opacity-60"
        >
          {loading ? (
            <>
